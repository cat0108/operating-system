...
OS的启动过程；  
OS中对中断机制的支持；     
### 实验未涉及知识点列举 OS原理中很重要，但是本次实验没有涉及到的知识点有：  
...
## 练习2解答
在interrupt_handler函数中完善时钟中断部分如下
![Alt text](09829db96005ad1aea725e33ba6d1ad.png)
运行结果演示如下  
![Alt text](77d2a1a1a50951ecbfd16c676dbce15.png)
### challenge1
...
完善异常中断后的代码如下：
![Alt text](06de592c692a9741bed12ff02fdfd1b.png)
在clock.c中的clock_init函数中写入内联汇编代码：
![Alt text](b4f2139cda8805503a05f511e2bf5c4.png)   
结果演示如下： 
![Alt text](faef5c9ad83cb4b46f4ce806ef72200.png)  
可以看到ebreak和异常指令中断都成功触发